...
\begin{longtable}{ |P{3cm}|P{4cm}|P{5cm}| }
	...
	\hline
 	...
 	\hline\hline
 	\endhead
	\multirow{3}{3cm}{\centering Grain Producer} & Correct management of grain ingest and classification & to be fairly paid \\
	\cline{2-3}
	 & \multirow{2}{4cm}{\centering Proper ingest receipt} & so he can get a credit on Rural Credit Banks\\
	 \cline{3-3}
	 & & and agree on a procution insurance \\
	 \hline
	 Rural Credit Bank agent & \multirow{2}{4cm}{\centering Accurate data from producers} & reduce credit giving risks\\
	 \cline{3-3}
